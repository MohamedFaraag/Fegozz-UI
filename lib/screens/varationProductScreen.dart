...
import 'package:fegoz/Model/ProdcutMdoel.dart';
...
import 'package:fegoz/widgets/varaitonWidget.dart';
...
class VarationProdcutScreen extends StatefulWidget {
  final image;
  ...
  @override
  _VarationProdcutScreenState createState() => _VarationProdcutScreenState();
}

class _VarationProdcutScreenState extends State<VarationProdcutScreen> {
  ...
  getListProduct() {
    for (Product product in DummyData.productList) {
